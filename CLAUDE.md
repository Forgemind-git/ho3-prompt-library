...
## About this project
A library of reusable prompts you run in Claude.ai.
**Primary way to do it:** Claude.ai chat (paste and run the prompts) — **no API key needed.**
...
- It's the **Prompt Library** hands-on. HTML prompt cards with copy buttons — no API key.
